...
public class UnsecureMessageService_PortType_Stub 
     extends weblogic.wsee.jaxrpc.StubImpl
     implements com.alsb.security.lib.UnsecureMessageService_PortType, /**/java.io.Serializable
{

  public UnsecureMessageService_PortType_Stub(weblogic.wsee.wsdl.WsdlPort port, 
                        weblogic.wsee.jaxrpc.ServiceImpl service) 
    throws javax.xml.rpc.ServiceException
  {
    super(port, com.alsb.security.lib.UnsecureMessageService_PortType.class, service);
  }
  ...
  private Object writeReplace() throws java.io.ObjectStreamException {
    java.util.HashMap map = new java.util.HashMap();
            map.put("UnsecureMessageServiceSOAP", "UnsecureMessageServiceSOAP");
            
    return new weblogic.wsee.tools.clientgen.stubgen.StubSerialWrapper(
      "com.alsb.security.lib.UnsecureMessageService_Service",
